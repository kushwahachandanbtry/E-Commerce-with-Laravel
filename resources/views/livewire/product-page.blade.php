                        ...
                        <ul>
                            <li class="mb-4">
                                <label for="featured" class="flex items-center dark:text-gray-300">
                                    <input id="featured" value="1" wire:model.live="featured" type="checkbox" class="w-4 h-4 mr-2">
                                    <span class="text-lg dark:text-gray-400">Featured Products</span>
                                </label>
                            </li>
                            <li class="mb-4">
                                <label for="onSale" class="flex items-center dark:text-gray-300">
                                    <input id="onSale" value="1" wire:model.live="onSale" type="checkbox" class="w-4 h-4 mr-2">
